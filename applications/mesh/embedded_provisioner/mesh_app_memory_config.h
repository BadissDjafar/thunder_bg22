...
#define MESH_CFG_MAX_PROVISIONED_DEVICES        4
#define MESH_CFG_MAX_PROVISIONED_DEVICE_APPKEYS 4
#define MESH_CFG_MAX_PROVISIONED_DEVICE_NETKEYS 4
#define MESH_CFG_MAX_FOUNDATION_CLIENT_CMDS     4
