...
static uint8_t led_array[BSP_LED_COUNT][2]=BSP_LED_INIT;/* 2 is for both the port and the pin number */
...
void IADC_IRQHandler(void)
{
  ...
  GPIO_PinOutToggle(led_array[0][0], led_array[0][1]); /* Use LED0 */
...
int main(void)
{
  ...
  GPIO_PinModeSet(led_array[0][0], led_array[0][1], gpioModePushPull, 0);
